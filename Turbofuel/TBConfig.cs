...
namespace ReikaKalseki.Turbofuel
{
	...
	{		
		public enum ConfigEntries {
			...
			[ConfigEntry("Turbofuel Blender Crafting Time", typeof(float), 4F, 1, 120, 0)]CRAFTER_TIME,
			[ConfigEntry("Turbofuel Sulfur Cost", typeof(int), 5, 1, 100, 0)]SULFUR_COST,
			[ConfigEntry("Turbofuel Coal Cost", typeof(int), 50, 1, 100, 0)]COAL_COST,
			[ConfigEntry("Turbofuel Uses HOF+Sulfur instead of HECF+Coal+Sulfur", true)]USE_HOF,
